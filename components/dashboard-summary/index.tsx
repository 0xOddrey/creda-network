...
export function DashboardSummary({ onDepositClick, onSendClick }: DashboardSummaryProps) {
  ...
  const dropdownTrigger = (
    <button className="btn-secondary rounded-full p-2.5 min-h-0 w-auto px-2.5">
  ...
  return (
    <Container className="flex w-full max-w-5xl flex-col items-center justify-between md:flex-row md:items-stretch">
      ...
      <div className="flex w-full items-center gap-2 md:w-auto md:justify-end">
        ...
        <button
          type="button"
          className="btn-secondary flex flex-grow items-center justify-center gap-2 md:w-40"
          onClick={onSendClick}
        >
